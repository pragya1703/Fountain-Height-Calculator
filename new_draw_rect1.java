...
public class new_draw_rect1 extends JPanel {
...
public static JFrame frame;
  ...
  public static void NewScreen() {
	    new_draw_rect1 rects1 = new new_draw_rect1();
		
       frame = new JFrame("Water Fountain For Medium Area");
       frame.setBounds(10,10,650,500);
		...
		slider.setMinimum(800);
		slider.setMaximum(1400);
